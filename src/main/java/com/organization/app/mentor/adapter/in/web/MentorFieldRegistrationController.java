...
public class MentorFieldRegistrationController {

    private final RegisterFieldUseCase registerFieldUseCase;
    private final ModifyFieldRegistrationUseCase modifyFieldRegistrationUseCase;
    ...
    public FieldRegistrationResponse registerField(@RequestBody @Valid RegisterFieldRequest request) {
        FieldRegistration registration = registerFieldUseCase.registerField(
    ...
    public FieldRegistrationResponse updateFieldRegistration(
            @PathVariable Long registrationId,
            @RequestBody @Valid RegisterFieldRequest request) {
        FieldRegistration registration = modifyFieldRegistrationUseCase.modifyFieldRegistration(
                ModifyFieldRegistrationUseCase.Command.builder()
                        .accountId(DUMMY_ACCOUNT_ID)
